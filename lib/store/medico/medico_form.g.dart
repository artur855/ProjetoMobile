...
mixin _$MedicoForm on _MedicoForm, Store {
  final _$nomeAtom = Atom(name: '_MedicoForm.nome');
  ...
  final _$crmAtom = Atom(name: '_MedicoForm.crm');
  ...
  final _$msgCrmAtom = Atom(name: '_MedicoForm.msgCrm');

  @override
  String get msgCrm {
    _$msgCrmAtom.context.enforceReadPolicy(_$msgCrmAtom);
    _$msgCrmAtom.reportObserved();
    return super.msgCrm;
  }

  @override
  set msgCrm(String value) {
    _$msgCrmAtom.context.conditionallyRunInAction(() {
      super.msgCrm = value;
      _$msgCrmAtom.reportChanged();
